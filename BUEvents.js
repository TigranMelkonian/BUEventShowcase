var items = [
{eventName: "Event1", organizer: "Chirag", participants : "100000", description : "socks only", registrationRequired : "NO", location : "Boston, MA", address : "IDK", city : "Boston", startTime : "69:00", endTime : "96:00", duration : "69hrs", _id : "69", cost : "69", minCost : "69", maxCost : "69", refundPolicy : "NONE", subOrganizers : "69", sponsors : "69"},
...
$(document).ready(function(){
                $( "#itemTemplate" ).tmpl( items ).appendTo( "#itemList thead" );
            });
$( rows ).appendTo( "#itemList thead" );
**/
...
ODIN.documentReady = function() {

	ODIN.buildSpotifyTable(items);
};

ODIN.buildSpotifyTable = function(items) {
	console.log(items);
